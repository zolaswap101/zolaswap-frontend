...
import { Flex, Text, Skeleton, Link, Button, ArrowForwardIcon } from 'packages/uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in ZOLA prizes this round', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with ZOLA, win ZOLA if your numbers match')}
        </Text>
      </Flex>
